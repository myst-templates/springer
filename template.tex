...
\affil[[-affiliation.index-]]{
    [#- if affiliation.department #]\orgdiv{[-affiliation.department-]} [# endif -#]
    [#- if affiliation.institution #]\orgname{[-affiliation.institution-]} [# endif -#]
    \orgaddress{
        [#- if affiliation.address #]\street{[-affiliation.address-]} [# endif -#]
        [#- if affiliation.city #]\city{[-affiliation.city-]} [# endif -#]
        [#- if affiliation.postcode #]\postcode{[-affiliation.postcode-]} [# endif -#]
        [#- if affiliation.state #]\state{[-affiliation.state-]} [# endif -#]
        [#- if affiliation.country #]\country{[-affiliation.country-]} [# endif -#]
    }
}
[# endfor -#]
